...
public class InternalRelationship implements LayoutRelationship {
	...
	public InternalRelationship(LayoutRelationship externalRelationship,
			InternalNode source, InternalNode destination) {
		...
		this.externalRelationship
				.populateLayoutConstraint(basicEdgeConstraints);
	}
	...
	public void setBendPoints(LayoutBendPoint[] bendPoints) {
		for (LayoutBendPoint layoutBendPoint : bendPoints) {
			this.bendPoints.add(layoutBendPoint);
		}
	}
	...
	public String toString() {
		return "(src: " + source + ", dst: " + destination + ", bend_points: "
				+ bendPoints.toString() + ")";
	}
